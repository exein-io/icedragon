...
fn main() -> anyhow::Result<()> {
    ...
    match command {
        ...
        Commands::Cargo(args) => {
            ...
            cargo(container_engine, runner, &triple, &container_image, &cmd)
        }
        Commands::Clang(args) => {
            let RunArgs {
                container_image,
            ...
            clang(container_engine, runner, &triple, &container_image, &cmd)
        }
        Commands::Cmake(args) => {
            let RunArgs {
                container_image,
            ...
            cmake(container_engine, runner, &triple, &container_image, &cmd)
        }
        Commands::Run(args) => {
            let RunArgs {
                container_image,
            ...
            run(container_engine, runner, &triple, &container_image, &cmd)
        }
    }
}
